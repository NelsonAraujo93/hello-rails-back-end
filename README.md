...
```
git clone https://github.com/NelsonAraujo93/hello-rails-back-end.git
```
...
Follow this [link](https://github.com/NelsonAraujo93/hello-react-front-end) to check the Front-End repository of this project
<p align="right">(<a href="#readme-top">back to top</a>)</p>
...
Feel free to check the [issues page](https://github.com/NelsonAraujo93/hello-rails-back-end/issues).
